...
class EdifyGenerator(object):
  ...
  def PrintCraftRomBanner(self, android_version, build_id, build_date,
                                  security_patch, device):
    self.Print("----------------------------------------------")
    self.Print("                CraftRom OS")
    self.Print("            Maintainer melles1991")
    self.Print("----------------------------------------------")
    self.Print(" [Android]        : %s"%(android_version))
